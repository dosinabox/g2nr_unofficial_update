...
instance Gil_Values(C_GILVALUES)
{
	...
	water_depth_knee[GIL_SCAVENGER] = 140;
	water_depth_chest[GIL_SCAVENGER] = 160;
	...
	swim_time[GIL_WISP] = TIME_INFINITE;
	dive_time[GIL_WISP] = 0;
	water_depth_knee[GIL_WISP] = 999999;
	water_depth_chest[GIL_WISP] = 999999;
	step_height[GIL_WISP] = 100;
	jumplow_height[GIL_WISP] = 800;
	slide_angle[GIL_WISP] = 50;
	disable_autoroll[GIL_WISP] = 0;
	surface_align[GIL_WISP] = 0;
	turn_speed[GIL_WISP] = 240;
	falldown_height[GIL_WISP] = 9999;
	falldown_damage[GIL_WISP] = 0;
	fight_range_base[GIL_WISP] = 80;
	fight_range_fist[GIL_WISP] = 80;
	fight_range_g[GIL_WISP] = 100;
	blood_disabled[GIL_WISP] = 1;
	...
	swim_time[GIL_SUMMONED_ZOMBIE] = 0;
	dive_time[GIL_SUMMONED_ZOMBIE] = 0;
	water_depth_knee[GIL_SUMMONED_ZOMBIE] = 90;
	water_depth_chest[GIL_SUMMONED_ZOMBIE] = 150;
	step_height[GIL_SUMMONED_ZOMBIE] = 60;
	jumplow_height[GIL_SUMMONED_ZOMBIE] = 200;
	slide_angle[GIL_SUMMONED_ZOMBIE] = 50;
	turn_speed[GIL_SUMMONED_ZOMBIE] = 240;
	climb_heading_angle[GIL_SUMMONED_ZOMBIE] = 50;
	climb_horiz_angle[GIL_SUMMONED_ZOMBIE] = 50;
	climb_ground_angle[GIL_SUMMONED_ZOMBIE] = 50;
	falldown_height[GIL_SUMMONED_ZOMBIE] = 9999;
	falldown_damage[GIL_SUMMONED_ZOMBIE] = 0;
	fight_range_base[GIL_SUMMONED_ZOMBIE] = 60;
	fight_range_fist[GIL_SUMMONED_ZOMBIE] = 50;
	fight_range_g[GIL_SUMMONED_ZOMBIE] = 300;
	blood_emitter[GIL_SUMMONED_ZOMBIE] = "BFX_Zombie";
	blood_texture[GIL_SUMMONED_ZOMBIE] = "BQM_Zombie.tga";
	blood_flow[GIL_SUMMONED_ZOMBIE] = 0;
	blood_amount[GIL_SUMMONED_ZOMBIE] = 10;
	blood_max_distance[GIL_SUMMONED_ZOMBIE] = 100;
	...
	blood_texture[GIL_DEMON] = "BQM_Skeleton.tga";
	...
	blood_texture[GIL_SUMMONED_DEMON] = "BQM_Skeleton.tga";
	...
	blood_emitter[GIL_SWAMPGOLEM] = "BFX_Preset2";
	blood_texture[GIL_SWAMPGOLEM] = "BQM_Meatbug.tga";
	blood_amount[GIL_SWAMPGOLEM] = 10;
	blood_max_distance[GIL_SWAMPGOLEM] = 100;
	swim_time[GIL_SHADOWBEAST_FIRE] = swim_time[GIL_SHADOWBEAST];
	dive_time[GIL_SHADOWBEAST_FIRE] = dive_time[GIL_SHADOWBEAST];
	water_depth_knee[GIL_SHADOWBEAST_FIRE] = water_depth_knee[GIL_SHADOWBEAST];
	water_depth_chest[GIL_SHADOWBEAST_FIRE] = water_depth_chest[GIL_SHADOWBEAST];
	step_height[GIL_SHADOWBEAST_FIRE] = step_height[GIL_SHADOWBEAST];
	jumplow_height[GIL_SHADOWBEAST_FIRE] = jumplow_height[GIL_SHADOWBEAST];
	jumpmid_height[GIL_SHADOWBEAST_FIRE] = jumpmid_height[GIL_SHADOWBEAST];
	jumpup_height[GIL_SHADOWBEAST_FIRE] = jumpup_height[GIL_SHADOWBEAST];
	slide_angle[GIL_SHADOWBEAST_FIRE] = slide_angle[GIL_SHADOWBEAST];
	turn_speed[GIL_SHADOWBEAST_FIRE] = turn_speed[GIL_SHADOWBEAST];
	climb_heading_angle[GIL_SHADOWBEAST_FIRE] = climb_heading_angle[GIL_SHADOWBEAST];
	climb_horiz_angle[GIL_SHADOWBEAST_FIRE] = climb_horiz_angle[GIL_SHADOWBEAST];
	climb_ground_angle[GIL_SHADOWBEAST_FIRE] = climb_ground_angle[GIL_SHADOWBEAST];
	falldown_height[GIL_SHADOWBEAST_FIRE] = falldown_height[GIL_SHADOWBEAST];
	falldown_damage[GIL_SHADOWBEAST_FIRE] = falldown_damage[GIL_SHADOWBEAST];
	fight_range_base[GIL_SHADOWBEAST_FIRE] = fight_range_base[GIL_SHADOWBEAST];
	fight_range_fist[GIL_SHADOWBEAST_FIRE] = fight_range_fist[GIL_SHADOWBEAST];
	fight_range_g[GIL_SHADOWBEAST_FIRE] = fight_range_g[GIL_SHADOWBEAST];
	blood_disabled[GIL_SHADOWBEAST_FIRE] = 1;
	...
	swim_time[GIL_SUMMONED_STONEGUARDIAN] = swim_time[GIL_STONEGOLEM];
	dive_time[GIL_SUMMONED_STONEGUARDIAN] = dive_time[GIL_STONEGOLEM];
	water_depth_knee[GIL_SUMMONED_STONEGUARDIAN] = water_depth_knee[GIL_STONEGOLEM];
	water_depth_chest[GIL_SUMMONED_STONEGUARDIAN] = water_depth_chest[GIL_STONEGOLEM];
	step_height[GIL_SUMMONED_STONEGUARDIAN] = step_height[GIL_HUMAN];
	jumplow_height[GIL_SUMMONED_STONEGUARDIAN] = jumplow_height[GIL_HUMAN];
	jumpmid_height[GIL_SUMMONED_STONEGUARDIAN] = jumpmid_height[GIL_HUMAN];
	jumpup_height[GIL_SUMMONED_STONEGUARDIAN] = jumpup_height[GIL_HUMAN];
	slide_angle[GIL_SUMMONED_STONEGUARDIAN] = slide_angle[GIL_HUMAN];
	turn_speed[GIL_SUMMONED_STONEGUARDIAN] = turn_speed[GIL_HUMAN];
	climb_heading_angle[GIL_SUMMONED_STONEGUARDIAN] = climb_heading_angle[GIL_HUMAN];
	climb_horiz_angle[GIL_SUMMONED_STONEGUARDIAN] = climb_horiz_angle[GIL_HUMAN];
	climb_ground_angle[GIL_SUMMONED_STONEGUARDIAN] = climb_ground_angle[GIL_HUMAN];
	falldown_height[GIL_SUMMONED_STONEGUARDIAN] = falldown_height[GIL_HUMAN];
	falldown_damage[GIL_SUMMONED_STONEGUARDIAN] = falldown_damage[GIL_HUMAN];
	fight_range_base[GIL_SUMMONED_STONEGUARDIAN] = fight_range_base[GIL_HUMAN];
	fight_range_fist[GIL_SUMMONED_STONEGUARDIAN] = fight_range_fist[GIL_HUMAN];
	fight_range_g[GIL_SUMMONED_STONEGUARDIAN] = fight_range_g[GIL_HUMAN];
	blood_emitter[GIL_SUMMONED_STONEGUARDIAN] = "BFX_Stoneguardian";
	blood_texture[GIL_SUMMONED_STONEGUARDIAN] = "BQM_Stoneguardian.tga";
	blood_flow[GIL_SUMMONED_STONEGUARDIAN] = blood_flow[GIL_STONEGOLEM];
	blood_amount[GIL_SUMMONED_STONEGUARDIAN] = blood_amount[GIL_STONEGOLEM];
	blood_max_distance[GIL_SUMMONED_STONEGUARDIAN] = blood_max_distance[GIL_STONEGOLEM];
};
