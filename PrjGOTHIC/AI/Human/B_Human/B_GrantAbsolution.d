...
{
	if((location == LOC_OW_OLDCAMP) || (location == LOC_ALL))
	{
	...
	if((location == LOC_NW_CITY) || (location == LOC_ALL))
	{
	...
	if((location == LOC_NW_MONASTERY) || (location == LOC_ALL))
	{
	...
	if((location == LOC_NW_BIGFARM) || (location == LOC_ALL))
	{
...
func void B_GrantPersonalAbsolution(var C_Npc slf)
{
	...
	{
		B_GrantAbsolution(LOC_OW_OLDCAMP);
		Garond_Schulden = 0;
	...
	{
		B_GrantAbsolution(LOC_NW_MONASTERY);
		Parlan_Schulden = 0;
	...
	{
		B_GrantAbsolution(LOC_NW_BIGFARM);
		Lee_Schulden = 0;
