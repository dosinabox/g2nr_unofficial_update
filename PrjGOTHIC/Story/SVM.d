...
instance SVM_5(C_SVM)
{
	...
	SheepKillerMonster = "SVM_5_SheepKillerMonster";	//Этот мерзкий монстр убивает наших овец!
	...
	RunCoward = "SVM_5_RunCoward";	//Стой, трус!
	...
	theft_crime = "SVM_5_THEFT_CRIME";	//Оставь меня в покое, презренный воришка!
	pal_city_crime = "SVM_5_PAL_CITY_CRIME";	//Ты позоришь наш орден! Подожди, лорд Хаген узнает об этом!
	mil_city_crime = "SVM_5_MIL_CITY_CRIME";	//Ты позоришь городскую стражу! Подожди, лорд Андрэ узнает об этом!
	city_crime = "SVM_5_CITY_CRIME";	//Подожди, лорд Андрэ узнает об этом!
	mona_crime = "SVM_5_MONA_CRIME";	//Подожди, отец Парлан узнает об этом!
	farm_crime = "SVM_5_FARM_CRIME";	//Подожди, Ли узнает об этом!
	oc_crime = "SVM_5_OC_CRIME";	//Подожди, командующий Гаронд узнает об этом!
	toughguy_attacklost = "SVM_5_TOUGHGUY_ATTACKLOST";	//Хорошо, хорошо, ты лучший боец. Чего ты хочешь?
	toughguy_attackwon = "SVM_5_TOUGHGUY_ATTACKWON";	//Я думаю, что теперь ты прекрасно знаешь, кто из нас сильнее... Чего ты хочешь?
	toughguy_playerattack = "SVM_5_TOUGHGUY_PLAYERATTACK";	//Я думал, ты хочешь сразиться со мной. Ты передумал? Ты предпочитаешь БОЛТАТЬ, да? (смеется)
	...
	Smalltalk01 = "SVM_5_Smalltalk01";	//...это действительно правда...
	Smalltalk02 = "SVM_5_Smalltalk02";	//...я слышал другое...
	Smalltalk03 = "SVM_5_Smalltalk03";	//...не говори, что ты не знал этого...
	Smalltalk04 = "SVM_5_Smalltalk04";	//...в наши дни даже и не знаешь, кому верить...
	Smalltalk05 = "SVM_5_Smalltalk05";	//...это все сплетни...
	Smalltalk06 = "SVM_5_Smalltalk06";	//...я сам не лучше...
	Smalltalk07 = "SVM_5_Smalltalk07";	//...меня больше ничего не удивляет...
	Smalltalk08 = "SVM_5_Smalltalk08";	//...это не мои проблемы...
	Smalltalk09 = "SVM_5_Smalltalk09";	//...ты действительно веришь в это?..
	Smalltalk10 = "SVM_5_Smalltalk10";	//...никто ничему не учится у меня...
	Smalltalk11 = "SVM_5_Smalltalk11";	//...это было всегда очевидно...
	Smalltalk12 = "SVM_5_Smalltalk12";	//...он слушал не тех людей...
	Smalltalk13 = "SVM_5_Smalltalk13";	//...если он этого не видит, я ничем не могу помочь...
	Smalltalk14 = "SVM_5_Smalltalk14";	//...это не новость...
	Smalltalk15 = "SVM_5_Smalltalk15";	//...он сам бы никогда не додумался...
	Smalltalk16 = "SVM_5_Smalltalk16";	//...это давно известно...
	Smalltalk17 = "SVM_5_Smalltalk17";	//...это плохой бизнес...
	Smalltalk18 = "SVM_5_Smalltalk18";	//...я бы сделал это по-другому...
	Smalltalk19 = "SVM_5_Smalltalk19";	//...я полностью с тобой согласен...
	Smalltalk20 = "SVM_5_Smalltalk20";	//...если все будет по-другому...
	Smalltalk21 = "SVM_5_Smalltalk21";	//...я даже не знал об этом...
	Smalltalk22 = "SVM_5_Smalltalk22";	//...с этим уже ничего не поделать...
	Smalltalk23 = "SVM_5_Smalltalk23";	//...это не удивляет меня...
	Smalltalk24 = "SVM_5_Smalltalk24";	//...но он настаивал, что ему лучше знать...
	Smalltalk25 = "SVM_5_Smalltalk25";	//...важна только сила, так что не надо...
	Smalltalk26 = "SVM_5_Smalltalk26";	//...он даже меч толком держать не умел...
	Smalltalk27 = "SVM_5_Smalltalk27";	//...да, он действительно сказал это...
	Smalltalk28 = "SVM_5_Smalltalk28";	//...кто-то должен заплатить за это...
	Smalltalk29 = "SVM_5_Smalltalk29";	//...Иннос просвещает тех, кто признает его мудрость...
	Smalltalk30 = "SVM_5_Smalltalk30";	//...правосудие восторжествует...
	...
	NoLearnYoureBetter = "SVM_5_NoLearnYoureBetter";	//Мне больше нечему учить тебя. Ты слишком хорош.
	...
	addon_wrongarmor_sld = "SVM_5_ADDON_WRONGARMOR_SLD";	//Что на тебе надето? Ты что, больше не один из нас? Тогда я не буду иметь дело с тобой.
...
instance SVM_6(C_SVM)
{
	...
	SheepKillerMonster = "SVM_6_SheepKillerMonster";	//Отойди от наших овец, тварь!
...
instance SVM_7(C_SVM)
{
	...
	CheerFriend03 = "SVM_7_CheerFriend03";	//Прикончи его!
	...
	Smalltalk18 = "SVM_7_Smalltalk18";	//...я бы сделал по-другому...
...
instance SVM_8(C_SVM)
{
	...
	SheepKillerMonster = "SVM_8_SheepKillerMonster";	//Этот мерзкий монстр убивает наших овец!
...
instance SVM_9(C_SVM)
{
	...
	RunCoward = "SVM_9_RunCoward";	//Мы еще встретимся!
	...
	toughguy_attackwon = "SVM_9_TOUGHGUY_ATTACKWON";	//Я думаю, теперь ты понимаешь, с кем имеешь дело. Чего ты хочешь?
...
instance SVM_10(C_SVM)
{
	...
	markt_2_kaserne = "SVM_10_MARKT_2_KASERNE";	//Это огромное здание - казармы. Чтобы попасть в них, просто поднимись по лестнице от отеля.
	...
	addon_wrongarmor_kdf = "SVM_10_ADDON_WRONGARMOR_KDF";	//Если ты отказываешься от робы, то отказываешься и от Инноса. Тебе следует задуматься об этом.
...
instance SVM_11(C_SVM)
{
	...
	SheepKillerMonster = "SVM_11_SheepKillerMonster";	//Этот мерзкий монстр убивает наших овец!
	...
	RunCoward = "SVM_11_RunCoward";	//Стой, трус!
...
instance SVM_12(C_SVM)
{
	...
	RunCoward = "SVM_12_RunCoward";	//Мы еще встретимся!
	...
	pal_city_crime = "SVM_12_PAL_CITY_CRIME";	//Ты так хочешь стать паладином? Ну подожди, вот лорд Хаген узнает о твоих делах!
	...
	addon_diebandit = "SVM_12_ADDON_DIEBANDIT";	//Я порву тебя на части, бандюга!
	addon_dirtypirate = "SVM_12_ADDON_DIRTYPIRATE";	//Я порву тебя на части, пират!
};
...
instance SVM_13(C_SVM)
{
	...
	SheepKillerMonster = "SVM_13_SheepKillerMonster";	//Этот мерзкий монстр убивает наших овец!
...
instance SVM_14(C_SVM)
{
	...
	SheepKillerMonster = "SVM_14_SheepKillerMonster";	//Этот мерзкий монстр убивает наших овец!
	...
	ThereIsNoFightingHere = "SVM_14_ThereIsNoFightingHere";	//Драки здесь запрещены, понятно? Пусть это послужит тебе уроком!
	...
	RunCoward = "SVM_14_RunCoward";	//Стой, трус!
...
instance SVM_16(C_SVM)
{
	...
	SheepKillerMonster = "SVM_16_SheepKillerMonster";	//Этот мерзкий монстр убивает наших овец!
	...
	RunCoward = "SVM_16_RunCoward";	//Прекрати! Трус!
	...
	CheerFriend01 = "SVM_16_CheerFriend01";	//Задай ему!
	...
	Smalltalk19 = "SVM_16_Smalltalk19";	//...я видела их...
...
instance SVM_17(C_SVM)
{
	...
	Smalltalk19 = "SVM_17_Smalltalk19";	//...и что еще хуже...
