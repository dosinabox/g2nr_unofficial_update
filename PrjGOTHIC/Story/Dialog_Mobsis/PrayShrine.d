...
func void PC_PrayShrine_HEALSHRINE_Info()
{
	...
	else
	{
		...
		AI_PrintScreen("¬се алтари очищены!",-1,YPOS_GoldGiven,FONT_ScreenSmall,2);
	};
...
func void PC_PrayShrine_Pray_Info()
{
	...
	else
	{
		...
		Info_AddChoice(PC_PrayShrine_Pray,"я хочу помолитьс€ и ничего не пожертвовать.",PC_PrayShrine_Pray_NoPay);
