...
func void Use_BookstandOWXardas1_S1()
{
	if(C_NpcIsHero(self))
	{
		...
		Doc_PrintLine(nDocID,0,"");
		Doc_PrintLines(nDocID,0,"ќсобенностью данных магических формул €вл€етс€ то, что хот€ они также заключены в рунах, использовать их может любой человек, обладающий магическими силами. ‘ормула может быть активирована мгновенно. Ќикаких ограничений дл€ магии телепортации нет.");
