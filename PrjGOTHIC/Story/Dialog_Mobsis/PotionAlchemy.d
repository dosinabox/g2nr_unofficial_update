...
instance PC_ItPo_Addon_Geist(C_Info)
{
	...
	permanent = TRUE;
	description = "Эликсир изменения сознания (2 жала кровавой мухи, 1 экстракт маны, 1 лечебная эссенция и 1 красный жгучий перец)";
};
...
instance PC_ItPo_MegaDrink(C_Info)
{
	...
	permanent = TRUE;
	description = ConcatStrings(NAME_MegaDrink," (10 драконьих яиц, 1 черный жемчуг, 1 сера)");
};
