...
func void Use_BookstandHistory3_S1()
{
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(her))
	{
		...
		Doc_PrintLines(nDocID,1,"Во всех местах большого скопления народа спокойствие поддерживают судьи. До них доходят сведения обо всех преступлениях, и в их обязанность входит вынесение приговора и восстановление порядка. Тот, кто стал жертвой преступления или был свидетелем такового, обязан сообщить об этом властям.");
