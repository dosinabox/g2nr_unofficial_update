...
func int B_TeachPlayerTalentSmith(var C_Npc slf,var C_Npc oth,var int waffe)
{
	...
	if(waffe == WEAPON_Common)
	{
		...
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ простого кованого меча мне не нужно никаких ингредиентов.");
	};
	...
	if(waffe == WEAPON_2H_Special_01)
	{
		...
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ двуручного рудного меча мне нужны 2 куска руды.");
	};
	if(waffe == WEAPON_1H_Special_02)
	{
		PLAYER_TALENT_SMITH[WEAPON_1H_Special_02] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ полуторного рудного меча мне нужны 2 куска руды.");
	};
	if(waffe == WEAPON_2H_Special_02)
	{
		PLAYER_TALENT_SMITH[WEAPON_2H_Special_02] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ т€желого двуручного рудного меча мне нужны 3 куска руды.");
	};
	if(waffe == WEAPON_1H_Special_03)
	{
		PLAYER_TALENT_SMITH[WEAPON_1H_Special_03] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ боевого рудного меча мне нужны 3 куска руды.");
	};
	if(waffe == WEAPON_2H_Special_03)
	{
		PLAYER_TALENT_SMITH[WEAPON_2H_Special_03] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ т€желого боевого рудного меча мне нужны 4 куска руды.");
	};
	if(waffe == WEAPON_1H_Special_04)
	{
		PLAYER_TALENT_SMITH[WEAPON_1H_Special_04] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ рудного '”бийцы драконов' мне нужны 4 куска руды и 5 флаконов крови дракона.");
	};
	if(waffe == WEAPON_2H_Special_04)
	{
		PLAYER_TALENT_SMITH[WEAPON_2H_Special_04] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ большого рудного '”бийцы драконов' мне нужны 5 кусков руды и 5 флаконов крови дракона.");
	};
	...
	if(waffe == WEAPON_1H_Harad_04)
	{
		...
		B_LogEntry(TOPIC_TalentSmith,"√арад передал мне секрет ковки 'Ёль-бастардо' - одного из лучших клинков в мире!");
	};
