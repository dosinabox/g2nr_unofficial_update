...
func int B_TeachPlayerTalentSmith(var C_Npc slf,var C_Npc oth,var int waffe)
{
	...
	if(waffe == WEAPON_1H_Special_04)
	{
		...
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ 'рудного убийцы драконов' мне нужны 4 куска руды и 5 флаконов крови дракона.");
	};
	if(waffe == WEAPON_2H_Special_04)
	{
		PLAYER_TALENT_SMITH[WEAPON_2H_Special_04] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"ƒл€ 'большого рудного убийцы драконов' мне нужны 5 кусков руды и 5 флаконов крови дракона.");
	};
