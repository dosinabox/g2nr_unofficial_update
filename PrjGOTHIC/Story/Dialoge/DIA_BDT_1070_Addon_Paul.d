...
{
	AI_Output(other,self,"DIA_Addon_Paul_MaulPaul_15_00");	//(дружелюбно) Поль, скажи мне, что тебе известно, или я размажу тебя по этой стенке!
	...
	AI_Output(other,self,"DIA_Addon_Paul_MaulPaul_15_04");	//(нетерпеливо) Поль...
