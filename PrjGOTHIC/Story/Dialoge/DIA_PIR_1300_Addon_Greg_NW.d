...
instance DIA_Addon_Greg_NW_Loc(C_Info)
{
	...
	description = "А что находится за этими горами?";
};
...
instance DIA_Addon_Greg_NW_Skip(C_Info)
{
	...
	description = "Недалеко от города я встретил пирата по имени Скип.";
};
...
func void DIA_Addon_Greg_NW_FoundTreasure_not()
{
	...
	AI_Output(self,other,"DIA_Addon_Greg_NW_FoundTreasure_not_01_01");	//Тогда поторопись и принеси их мне, пока я не рассердился.
	AI_StopProcessInfos(self);
};
