...
func void B_BuildLearnDialog_Keroloth()
{
	...
	{
		Info_AddChoice(DIA_Keroloth_Teacher,B_BuildLearnTalentString(other,NPC_TALENT_2H,1),DIA_Keroloth_Teacher_2H_1);
		Info_AddChoice(DIA_Keroloth_Teacher,B_BuildLearnTalentString(other,NPC_TALENT_2H,5),DIA_Keroloth_Teacher_2H_5);
	...
	{
		Info_AddChoice(DIA_Keroloth_Teacher,B_BuildLearnTalentString(other,NPC_TALENT_1H,1),DIA_Keroloth_Teacher_1H_1);
		Info_AddChoice(DIA_Keroloth_Teacher,B_BuildLearnTalentString(other,NPC_TALENT_1H,5),DIA_Keroloth_Teacher_1H_5);
