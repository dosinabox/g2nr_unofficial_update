...
func void DIA_Parcival_Schurfer_Info()
{
	...
	Log_AddEntry(TOPIC_ScoutMine,"Группа Маркоса пошла по направлению к старой шахте. Их разведчиком был рудокоп Гримс.");
	Log_AddEntry(TOPIC_ScoutMine,"Другие две группы вышли вместе. Они разбили лагерь неподалеку от большой башни.");
};
