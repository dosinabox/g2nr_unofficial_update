...
func int DIA_DMT_Dementor_EXIT_Condition()
{
	return TRUE;
};

func void DIA_DMT_Dementor_EXIT_Info()
{
	B_AssignDementorTalk_Ritual_Exit();
};

func int DIA_DMT_Dementor_Condition()
{
...
func void DIA_DMT_Dementor_Info()
{
...
instance DIA_DMT_1202_Dementor_EXIT(C_Info)
{
	...
	nr = 999;
	condition = DIA_DMT_Dementor_EXIT_Condition;
	information = DIA_DMT_Dementor_EXIT_Info;
	permanent = TRUE;
...
instance DIA_DMT_1202_Dementor(C_Info)
{
	npc = DMT_1202_Dementor;
	nr = 1;
	condition = DIA_DMT_Dementor_Condition;
	information = DIA_DMT_Dementor_Info;
	important = TRUE;
	permanent = TRUE;
};
