...
{
	B_StealItem(20,ItKe_City_Tower_01,1);
	Info_ClearChoices(DIA_Pablo_PICKPOCKET);
};
...
func int DIA_Pablo_Banditen_Condition()
{
	...
	{
		DIA_Pablo_Banditen.description = "Что ты знаешь об этих бандитах?";
	}
	else
	{
		DIA_Pablo_Banditen.description = "Что ты знаешь о бандитах?";
	};
	return TRUE;
};
