...
instance DIA_BDT_1024_MalethsBandit_EXIT(C_Info)
{
	npc = BDT_1024_MalethsBandit;
	nr = 999;
	condition = DIA_BDT_1024_MalethsBandit_EXIT_Condition;
	information = DIA_BDT_1024_MalethsBandit_EXIT_Info;
	permanent = TRUE;
	description = Dialog_Ende;
};


func int DIA_BDT_1024_MalethsBandit_EXIT_Condition()
{
	return TRUE;
};

func void DIA_BDT_1024_MalethsBandit_EXIT_Info()
{
...
instance DIA_BDT_1024_MalethsBandit_AMBUSH(C_Info)
{
	npc = BDT_1024_MalethsBandit;
	nr = 2;
	condition = DIA_BDT_1024_MalethsBandit_AMBUSH_Condition;
	information = DIA_BDT_1024_MalethsBandit_AMBUSH_Info;
	important = TRUE;
};


func int DIA_BDT_1024_MalethsBandit_AMBUSH_Condition()
{
	return TRUE;
};

func void DIA_BDT_1024_MalethsBandit_AMBUSH_Info()
{
