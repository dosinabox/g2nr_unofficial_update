...
func void B_SCGetTreasure_S1()
{
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(hero))
	{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_02) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[2] == FALSE))
		{
			Wld_InsertItem(ItSe_GoldPocket100,RAKEPLACE_WP_02);
			RakeTreasureSuccess(ItSe_GoldPocket100);
			RAKEPLACE[2] = TRUE;
		}
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_03) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[3] == FALSE))
		{
			Wld_InsertItem(ItMi_GoldChalice,RAKEPLACE_WP_03);
			RakeTreasureSuccess(ItMi_GoldChalice);
			RAKEPLACE[3] = TRUE;
		}
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_04) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[4] == FALSE))
		{
			Wld_InsertItem(ItMi_GregsSilverPlate,RAKEPLACE_WP_04);
			RakeTreasureSuccess(ItMi_GregsSilverPlate);
			RAKEPLACE[4] = TRUE;
		}
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_05) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[5] == FALSE))
		{
			Wld_InsertItem(ItAm_Addon_Greg,RAKEPLACE_WP_05);
			RakeTreasureSuccess(ItAm_Addon_Greg);
			RAKEPLACE[5] = TRUE;
		}
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_12) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[12] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_13) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[13] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_14) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[14] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_15) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[15] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_16) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[16] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_17) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[17] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_18) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[18] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_19) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[19] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_20) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[20] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_21) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[21] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_22) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[22] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_23) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[23] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_24) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[24] == FALSE))
		{
			Wld_InsertItem(ItSE_Addon_FrancisChest,RAKEPLACE_WP_24);
			RakeTreasureSuccess(ItSE_Addon_FrancisChest);
			RAKEPLACE[24] = TRUE;
		}
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_25) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[25] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_26) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[26] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_27) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[27] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_28) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[28] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_29) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[29] == FALSE))
		{
		...
		else if((Npc_GetDistToWP(hero,RAKEPLACE_WP_30) < RAKE_BUDDEL_DIST_MIN) && (RAKEPLACE[30] == FALSE))
		{
