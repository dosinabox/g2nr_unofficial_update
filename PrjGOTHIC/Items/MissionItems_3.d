...
func void Use_DiegosLetter_Mis()
{
	...
	Doc_PrintLines(nDocID,0,"Я вернулся в город и ищу тебя. И когда я найду тебя, то вспорю твое жирное брюхо. Ты хорошо меня знаешь, так что не надейся, меня так легко не обвести вокруг пальца.");
