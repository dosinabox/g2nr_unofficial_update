...
const int Value_Sc_TrfGiantRat = 300;
const int Value_Sc_TrfWolf = 400;
const int Value_Sc_TrfScavenger = 500;
const int Value_Sc_TrfGiantBug = 600;
const int Value_Sc_TrfLurker = 700;
const int Value_Sc_TrfSnapper = 800;
const int Value_Sc_TrfWaran = 900;
const int Value_Sc_TrfWarg = 1000;
const int Value_Sc_TrfShadowbeast = 1100;
const int Value_Sc_TrfFireWaran = 1300;
const int Value_Sc_TrfDragonSnapper = 1500;
