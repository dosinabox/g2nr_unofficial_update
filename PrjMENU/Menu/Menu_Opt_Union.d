...
instance MENU_OPT_UNION(C_MENU_DEF)
{
	...
	items[18] = "MENUITEM_UNION_TELEPORTBETWEENWORLDS";
	items[19] = "MENUITEM_UNION_TELEPORTBETWEENWORLDS_CHOICE";
	items[20] = "MENUITEM_UNION_BACK";
...
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Платное обучение";
	text[1] = "Требование золота для всех учителей";
	posx = 700;
...
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Честное обучение";
	text[1] = "Правильный расчет цены обучения при пороговых значениях";
	posx = 700;
...
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Лимит боеприпасов";
	text[1] = "Лимит запаса стрел и болтов у торговцев";
	posx = 700;
...
instance MENUITEM_UNION_TELEPORTBETWEENWORLDS(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Свободные телепорты";
	text[1] = "Разрешать телепортацию с загрузочными экранами";
	posx = 700;
...
instance MENUITEM_UNION_TELEPORTBETWEENWORLDS_CHOICE(C_MENU_ITEM_DEF)
{
	backpic = MENU_CHOICE_BACK_PIC;
	type = MENU_ITEM_CHOICEBOX;
	text[0] = MENU_TEXT_OFFON;
	...
	dimx = MENU_SLIDER_DX;
	dimy = MENU_CHOICE_DY;
	onchgsetoption = "TeleportBetweenWorldsEnabled";
	onchgsetoptionsection = "SCRIPTPATCH";
	flags = flags & ~IT_SELECTABLE;
	flags = flags | IT_TXT_CENTER;
};
