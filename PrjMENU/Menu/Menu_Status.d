...
instance MENU_STATUS(C_MENU_DEF)
{
	...
	items[5] = "MENU_ITEM_TALENT_7_SKILL";
	items[6] = "MENU_ITEM_EXP_TITLE";
	items[7] = "MENU_ITEM_EXP";
	items[8] = "MENU_ITEM_LEVEL_NEXT_TITLE";
	items[9] = "MENU_ITEM_LEVEL_NEXT";
	items[10] = "MENU_ITEM_LEARN_TITLE";
	items[11] = "MENU_ITEM_LEARN";
	items[12] = "MENU_ITEM_ATTRIBUTE_HEADING";
	items[13] = "MENU_ITEM_ATTRIBUTE_1_TITLE";
	items[14] = "MENU_ITEM_ATTRIBUTE_2_TITLE";
	items[15] = "MENU_ITEM_ATTRIBUTE_3_TITLE";
	items[16] = "MENU_ITEM_ATTRIBUTE_4_TITLE";
	items[17] = "MENU_ITEM_ATTRIBUTE_1";
	items[18] = "MENU_ITEM_ATTRIBUTE_2";
	items[19] = "MENU_ITEM_ATTRIBUTE_3";
	items[20] = "MENU_ITEM_ATTRIBUTE_4";
	items[21] = "MENU_ITEM_ARMOR_HEADING";
	items[22] = "MENU_ITEM_ARMOR_1_TITLE";
	items[23] = "MENU_ITEM_ARMOR_2_TITLE";
	items[24] = "MENU_ITEM_ARMOR_3_TITLE";
	items[25] = "MENU_ITEM_ARMOR_4_TITLE";
	items[26] = "MENU_ITEM_ARMOR_1";
	items[27] = "MENU_ITEM_ARMOR_2";
	items[28] = "MENU_ITEM_ARMOR_3";
	...
	items[43] = "MENU_ITEM_TALENT_8_TITLE";
	items[44] = "MENU_ITEM_TALENT_8_SKILL";
	items[45] = "MENU_ITEM_TALENT_5_TITLE";
	items[46] = "MENU_ITEM_TALENT_5_SKILL";
	items[47] = "MENU_ITEM_TALENT_12_TITLE";
	items[48] = "MENU_ITEM_TALENT_12_SKILL";
	items[49] = "MENU_ITEM_TALENT_14_TITLE";
	items[50] = "MENU_ITEM_TALENT_14_SKILL";
	items[51] = "MENU_ITEM_TALENT_15_TITLE";
	items[52] = "MENU_ITEM_TALENT_15_SKILL";
	items[53] = "MENU_ITEM_TALENT_13_TITLE";
	items[54] = "MENU_ITEM_TALENT_13_SKILL";
	items[55] = "MENU_ITEM_TALENT_16_TITLE";
	items[56] = "MENU_ITEM_TALENT_16_SKILL";
	items[57] = "MENU_ITEM_TALENT_11_TITLE";
	items[58] = "MENU_ITEM_TALENT_11_SKILL";
	items[59] = "MENU_ITEM_TALENT_17_TITLE";
	items[60] = "MENU_ITEM_TALENT_17_SKILL";
	items[61] = "MENU_ITEM_TALENT_19_TITLE";
	items[62] = "MENU_ITEM_TALENT_19_SKILL";
